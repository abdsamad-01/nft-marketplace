...
pragma solidity ^0.8.4; // set version to match with waht we have in our hardhat
...
contract NFTMarketplace is ERC721URIStorage {
    ...
    function createToken(string memory tokenURI, uint256 price) public payable returns
    (uint) {
        _tokenIds.increment();
